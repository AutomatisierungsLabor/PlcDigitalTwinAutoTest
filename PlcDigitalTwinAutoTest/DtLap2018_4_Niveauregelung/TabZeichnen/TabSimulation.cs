...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmLap2018 vmLap2018, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.EllipseMarginStrokeBindingFilling(27, 3, 10, 3, kreisRand, kreisRandFarbe, 2, nameof(vmLap2018.BrushP1));
        libWpf.Text("Störung", 27, 3, 10, 3, HorizontalAlignment.Right, VerticalAlignment.Center, 20, Brushes.Black);

        libWpf.EllipseMarginStrokeBindingFilling(27, 3, 14, 3, kreisRand, kreisRandFarbe, 2, nameof(vmLap2018.BrushP2));
        libWpf.Text("Betrieb", 27, 3, 14, 3, HorizontalAlignment.Right, VerticalAlignment.Center, 20, Brushes.Black);

        libWpf.EllipseMarginStrokeBindingFilling(27, 3, 18, 3, kreisRand, kreisRandFarbe, 2, nameof(vmLap2018.BrushP3));
        ...
        libWpf.RectangleMarginBindingFill(5, 4, 4, 2, new Thickness(0, 15, 15, 15), nameof(vmLap2018.BrushZuleitungLinksWaagrecht));
        libWpf.RectangleMarginBindingFill(8, 2, 4, 8, new Thickness(15, 15, 15, 0), nameof(vmLap2018.BrushZuleitungLinksSenkrecht));

        libWpf.ImageMarginZweiBilderRotateBindingVisibility("PumpeEin.jpg", "PumpeAus.jpg", 6, 2, 4, 2, 90, new Thickness(0, 0, 0, 0), nameof(vmLap2018.VisibilityEinQ1), nameof(vmLap2018.VisibilityAusQ1));
        ...
        libWpf.RectangleMarginBindingFill(10, 4, 4, 2, new Thickness(15, 15, 0, 15), nameof(vmLap2018.BrushZuleitungRechtsWaagrecht));
        libWpf.RectangleMarginBindingFill(10, 2, 4, 8, new Thickness(15, 15, 15, 0), nameof(vmLap2018.BrushZuleitungRechtsSenkrecht));

        libWpf.ImageMarginZweiBilderRotateBindingVisibility("PumpeEin.jpg", "PumpeAus.jpg", 14, 2, 6, 2, 270, new Thickness(0, 0, 0, 0), nameof(vmLap2018.VisibilityEinQ2), nameof(vmLap2018.VisibilityAusQ2));
        ...
        libWpf.RectangleFillBindingMargin(6, 8, 7, 12, Brushes.Blue, nameof(vmLap2018.ThicknessFuellstand));

        libWpf.TextBindingContent(6, 8, 12, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 25, Brushes.GreenYellow, nameof(vmLap2018.StringFuellstand));

        libWpf.RectangleMarginBindingFill(9, 2, 19, 2, new Thickness(15, 0, 15, 0), nameof(vmLap2018.BrushZuleitungRechtsWaagrecht));
        libWpf.RectangleMarginBindingFill(9, 2, 22, 3, new Thickness(15, 0, 15, 0), nameof(vmLap2018.BrushZuleitungRechtsSenkrecht));
        ...
        libWpf.ImageMarginZweiBilderBindingVisibility("Schwimmerschalter.jpg", "SchwimmerschalterBetaetigt.jpg", 15, 3, 7, 2, new Thickness(0, 0, 25, 0), nameof(vmLap2018.VisibilityEinB3), nameof(vmLap2018.VisibilityAusB3));
        libWpf.Text("B3", 14, 2, 7, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);

        libWpf.ImageMarginZweiBilderBindingVisibility("Schwimmerschalter.jpg", "SchwimmerschalterBetaetigt.jpg", 15, 3, 14, 2, new Thickness(0, 0, 25, 0), nameof(vmLap2018.VisibilityEinB2), nameof(vmLap2018.VisibilityAusB2));
        libWpf.Text("B2", 14, 2, 14, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);

        libWpf.ImageMarginZweiBilderBindingVisibility("Schwimmerschalter.jpg", "SchwimmerschalterBetaetigt.jpg", 15, 3, 17, 2, new Thickness(0, 0, 25, 0), nameof(vmLap2018.VisibilityEinB1), nameof(vmLap2018.VisibilityAusB1));
