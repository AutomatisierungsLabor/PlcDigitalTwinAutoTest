...

{
    ...
    internal void Rangieren()
    {
        ...
        {
            case BetriebsartProjekt.LaborPlatte: (_modelLap2010.B1, _modelLap2010.B2, _modelLap2010.F1, _modelLap2010.S1, _modelLap2010.S2, _, _, _) = _datenstruktur.GetBitmuster(DatenBereich.Di, 0); break;
            case BetriebsartProjekt.Simulation: _datenstruktur.SetBitmuster(DatenBereich.Di, 0, _modelLap2010.B1, _modelLap2010.B2, _modelLap2010.F1, _modelLap2010.S1, _modelLap2010.S2); break;
        }
