...
public partial class VmLap2010 : BasePlcDtAt.BaseViewModel.VmBase
{
    ...
    protected override void ViewModelAufrufThread()
    {
        ...
        RipFarbeUmschalten(_modelLap2010!.B2, 2, Brushes.LawnGreen, Brushes.Red);
        RipFarbeUmschalten(_modelLap2010!.F1, 3, Brushes.LawnGreen, Brushes.Red);
        RipFarbeUmschalten(_modelLap2010!.P1, 4, Brushes.Red, Brushes.White);
        RipFarbeUmschalten(_modelLap2010!.P2, 5, Brushes.LawnGreen, Brushes.White);
        RipFarbeUmschalten(_modelLap2010!.Q1, 6, Brushes.LawnGreen, Brushes.White);
        RipFarbeUmschalten(_modelLap2010!.Q2, 7, Brushes.LawnGreen, Brushes.White);
        RipFarbeUmschalten(_modelLap2010!.Q3, 8, Brushes.LawnGreen, Brushes.White);
