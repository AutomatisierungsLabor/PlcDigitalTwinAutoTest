...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmLap2010 vmLap2010, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.RectangleMarginBindingFill(5, 4, 4, 2, new Thickness(0, 20, 10, 20), nameof(vmLap2010.BrushZuleitungWaagrecht));
        libWpf.RectangleMarginBindingFill(8, 2, 4, 10, new Thickness(20, 20, 20, 0), nameof(vmLap2010.BrushZuleitungSenkrecht));

        libWpf.RectangleFill(6, 6, 6, 10, Brushes.LightBlue);
        libWpf.RectangleFillBindingMargin(6, 6, 6, 10, Brushes.Blue, nameof(vmLap2010.MarginPegel));
        ...
        libWpf.ImageMarginBindingVisibility("PumpeWaagrechtAus.jpg", 4, 2, 4, 2, pumpeRand, nameof(vmLap2010.VisibilityAusQ1));
        libWpf.ImageMarginBindingVisibility("PumpeWaagrechtEin.jpg", 4, 2, 4, 2, pumpeRand, nameof(vmLap2010.VisibilityEinQ1));


        libWpf.RectangleMarginBindingFill(8, 2, 16, 3, new Thickness(20, 0, 20, 0), nameof(vmLap2010.BrushAbleitungOben));
        libWpf.RectangleMarginBindingFill(8, 2, 19, 3, new Thickness(20, 0, 20, 0), nameof(vmLap2010.BrushAbleitungUnten));
        ...
        libWpf.ImageMarginBindingVisibility("Schwimmerschalter.jpg", 13, 2, 7, 2, kontakteRand, nameof(vmLap2010.VisibilityAusB1));
        libWpf.ImageMarginBindingVisibility("SchwimmerschalterBetaetigt.jpg", 13, 2, 7, 2, kontakteRand, nameof(vmLap2010.VisibilityEinB1));


        libWpf.Text("B2", 12, 2, 14, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ImageMarginBindingVisibility("Schwimmerschalter.jpg", 13, 2, 14, 2, kontakteRand, nameof(vmLap2010.VisibilityAusB2));
        libWpf.ImageMarginBindingVisibility("SchwimmerschalterBetaetigt.jpg", 13, 2, 14, 2, kontakteRand, nameof(vmLap2010.VisibilityEinB2));
