...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmLap2010 vmLap2010, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.ButtonContentRounded("Hand", 20, 3, 2, 2, 14, 0, buttonRand, Brushes.LawnGreen, vmLap2010.ButtonTasterCommand, "Hand", nameof(vmLap2010.ClickModeHand));
        libWpf.ButtonContentRounded("Aus", 23, 3, 2, 2, 14, 0, buttonRand, Brushes.Gray, vmLap2010.ButtonTasterCommand, "Aus", nameof(vmLap2010.ClickModeAus));
        libWpf.ButtonContentRounded("Automatik", 26, 3, 2, 2, 14, 0, buttonRand, Brushes.Green, vmLap2010.ButtonTasterCommand, "Automatik", nameof(vmLap2010.ClickModeAutomatik));
        ...
        libWpf.ButtonContentRounded("Reset", 22, 3, 15, 2, 14, 15, buttonRand, Brushes.Red, vmLap2010.ButtonTasterCommand, "S3", nameof(vmLap2010.ClickModeS3));
