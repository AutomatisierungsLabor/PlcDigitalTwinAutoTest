...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmKata vmKata, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.Button(1, 3, 1, 2, 20, buttonRand, vmKata.BtnTaster, WpfObjects.S1,false);
        libWpf.Button(1, 3, 3, 2, 20, buttonRand, vmKata.BtnTaster, WpfObjects.S2, false);
        libWpf.Button(1, 3, 5, 2, 20, buttonRand, vmKata.BtnTaster, WpfObjects.S3, false);
        libWpf.Button(1, 3, 7, 2, 20, buttonRand, vmKata.BtnTaster, WpfObjects.S4, false);
