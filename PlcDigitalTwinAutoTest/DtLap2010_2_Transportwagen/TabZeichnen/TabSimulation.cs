...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmLap2010 vmLap2010, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.EllipseMarginStrokeBindingFilling(27, 3, 8, 3, kreisRand, kreisRandFarbe, 2, nameof(vmLap2010.BrushP1));
        ...
        libWpf.RectangleFillBindingVisibility(8, 2, 2, 4, Brushes.Firebrick, nameof(vmLap2010.VisibilityFuellen));
        ...
        libWpf.RectangleFillStrokeBindingMargin(1, 20, 8, 4, Brushes.Gray, Brushes.Black, 3, nameof(vmLap2010.PositionWagenkasten));
        libWpf.EllipseFillStrokeBindingMargin(1, 20, 12, 1, Brushes.Red, Brushes.Black, 2, nameof(vmLap2010.PositionRadLinks));
        libWpf.EllipseFillStrokeBindingMargin(1, 20, 12, 1, Brushes.Red, Brushes.Black, 2, nameof(vmLap2010.PositionRadRechts));
        ...
        libWpf.RectangleStrokeBindingFill(9, 2, 15, 2, Brushes.Black, 2, nameof(vmLap2010.BrushQ1));
        libWpf.RectangleStrokeBindingFill(11, 2, 15, 2, Brushes.Black, 2, nameof(vmLap2010.BrushQ2));
