...

{
    ...
    internal void Rangieren()
    {
        ...
        {
            _datenstruktur.SetBitmuster(DatenBereich.Di, 0, _modelLap2010.B1, _modelLap2010.B2, _modelLap2010.B3, _modelLap2010.S1, _modelLap2010.S2, _modelLap2010.S3);
        }
        else
        {
            (_modelLap2010.B1, _modelLap2010.B2, _modelLap2010.B3, _modelLap2010.S1, _modelLap2010.S2, _modelLap2010.S3, _, _) = _datenstruktur.GetBitmuster(DatenBereich.Di, 0);
        }
