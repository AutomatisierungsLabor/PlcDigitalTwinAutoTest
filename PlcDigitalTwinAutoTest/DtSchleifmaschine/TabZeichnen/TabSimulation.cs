...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmSchleifmaschine vmSchleifmaschine, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.ButtonContentRounded(4, 3, 15, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmSchleifmaschine.BtnTaster, WpfObjects.S1);

        libWpf.Text("-S0", 2, 2, 18, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ButtonContentRounded(4, 3, 18, 2, 20, 5, buttonRand, Brushes.Red, vmSchleifmaschine.BtnTaster, WpfObjects.S0);

        libWpf.Text("-S2", 2, 2, 20, 3, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ButtonContentRounded(4, 3, 20, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmSchleifmaschine.BtnTaster, WpfObjects.S2);
        ...
        libWpf.ButtonContentRounded(32, 3, 1, 3, 50, 5, buttonRand, Brushes.LawnGreen, vmSchleifmaschine.BtnSchalter, WpfObjects.F1);

        libWpf.Text("-F2", 30, 2, 4, 3, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ButtonContentRounded(32, 3, 4, 3, 50, 5, buttonRand, Brushes.LawnGreen, vmSchleifmaschine.BtnSchalter, WpfObjects.F2);
        ...
        libWpf.KreisStrokeMarginSetFilling(32, 3, 8, 3, kreisRandFarbe, kreisRand, WpfObjects.P1);
        ...
        libWpf.KreisStrokeMarginSetFilling(32, 3, 12, 3, kreisRandFarbe, kreisRand, WpfObjects.P2);
        ...
        libWpf.KreisStrokeMarginSetFilling(32, 3, 16, 3, kreisRandFarbe, kreisRand, WpfObjects.P3);
        ...
        libWpf.ButtonContentRounded(32, 3, 21, 2, 20, 5, buttonRand, Brushes.Red, vmSchleifmaschine.BtnTaster, WpfObjects.S4);

        libWpf.ButtonZweiBilder(22, 4, 15, 4, "NotHalt.jpg", "NotHaltGedrueckt.jpg", new Thickness(0, 0, 0, 0), vmSchleifmaschine.BtnSchalter, WpfObjects.S3);
