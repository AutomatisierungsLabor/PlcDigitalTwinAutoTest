...
public partial class TestAutomat
{
    ...
    public void FuncSetDiagrammZeitbereich(FunctionEventArgs args) => _datenstruktur.DiagrammZeitbereich = args.Parameters[0].ToInteger();
    public void FuncSetDataGridBitAnzahl()
    {
