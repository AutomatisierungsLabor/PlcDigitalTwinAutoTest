...
public class TestDaBitmusterBlinktTesten
{
    ...
    [Theory]
    [InlineData(1, 1, "T#20ms", 0.5, 2, 0.3, "T#1000ms", "kein TestKommentar", 10, 20, 1, TestAnzeige.Erfolgreich)]
    [InlineData(1, 1, "T#40ms", 0.5, 2, 0.3, "T#1000ms", "kein TestKommentar", 20, 40, 1, TestAnzeige.Erfolgreich)]
    [InlineData(1, 1, "T#40ms", 0.25, 2, 0.3, "T#1000ms", "kein TestKommentar", 10, 40, 1, TestAnzeige.Erfolgreich)]
    [InlineData(1, 1, "T#40ms", 0.75, 2, 0.3, "T#1000ms", "kein TestKommentar", 30, 40, 1, TestAnzeige.Erfolgreich)]

    [InlineData(1, 2, "T#100ms", 0.5, 2, 0.1, "T#500ms", "kein TestKommentar", 25, 50, 1, TestAnzeige.Timeout)]   // Bitmuster != Bitmaske
