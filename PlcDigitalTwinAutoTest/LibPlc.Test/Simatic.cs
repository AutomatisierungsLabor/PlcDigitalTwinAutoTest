...
public class Simatic
{
    ...
    {
        Assert.Equal(siemens, LibPlc.Simatic.Analog_2_Int16(analog, scale));
    }
    ...
    {
        Assert.Equal(siemens, LibPlc.Simatic.Analog_2_Int32(analog, scale));
    }
    ...
    {
        Assert.Equal(siemens, LibPlc.Simatic.Analog_2_Double(analog, scale), 3);
    }
    ...
    {
        Assert.Equal(exp, LibPlc.Simatic.Clamp(wert, min, max), 3);
    }
    ...
    {
        Assert.Equal(exp, LibPlc.Simatic.Digital_GetLowByte(wert));
    }
    ...
    {
        Assert.Equal(exp, LibPlc.Simatic.Digital_GetHighByte(wert));
    }
    ...
    {
        Assert.Equal(exp, LibPlc.Simatic.Digital_CombineTwoByte(low, high));
    }
