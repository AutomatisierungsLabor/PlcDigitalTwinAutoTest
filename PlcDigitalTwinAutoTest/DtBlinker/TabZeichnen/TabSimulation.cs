...
public partial class TabZeichnen
{
    public static ScottPlot.WpfPlot TabSimulationZeichnen(VmBlinker vmBlinker, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.ButtonRounded(25, 4, 8, 4, 25, 15, buttonRand, Brushes.Yellow, vmBlinker.BtnTaster, WpfObjects.S1);
        libWpf.ButtonRounded(31, 4, 8, 4, 25, 15, buttonRand, Brushes.GreenYellow, vmBlinker.BtnTaster, WpfObjects.S2);

        libWpf.Text("Tastverhältnis", 25, 10, 15, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 30, Brushes.Black);
        libWpf.ButtonRounded(25, 4, 17, 4, 25, 15, buttonRand, Brushes.Yellow, vmBlinker.BtnTaster, WpfObjects.S3);
        libWpf.ButtonRounded(31, 4, 17, 4, 25, 15, buttonRand, Brushes.GreenYellow, vmBlinker.BtnTaster, WpfObjects.S4);

        libWpf.ButtonRounded(28, 4, 1, 4, 30, 15, buttonRand, Brushes.Violet, vmBlinker.BtnTaster, WpfObjects.S5);
