...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmLap2018 vmLap2018, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.EllipseMarginStrokeBindingFilling(4, 2, 9, 2, new Thickness(4, 4, 4, 4), Brushes.Black, 2, nameof(vmLap2018.BrushQ2));
        ...
        libWpf.RectangleFillBindingMargin(15, 8, 5, 8, Brushes.Firebrick, nameof(vmLap2018.MarginSilo));
        libWpf.Text("Materialsilo", 15, 8, 5, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.TextBindingContent(15, 8, 10, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 20, Brushes.Black, nameof(vmLap2018.StringMaterialSiloFuellstand));

        libWpf.Text("Y1", 16, 2, 14, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ImageMarginZweiBilderBindingVisibility("VentilElektrischEin.jpg", "VentilElektrischAus.jpg", 17, 3, 14, 2, new Thickness(0, 0, 5, 0), nameof(vmLap2018.VisibilityEinY1), nameof(vmLap2018.VisibilityAusY1));
        libWpf.RectangleMarginBindingFill(15, 8, 13, 1, new Thickness(110, 0, 110, 0), nameof(vmLap2018.BrushMaterialOben));
        libWpf.RectangleMarginBindingFill(15, 8, 16, 2, new Thickness(110, 0, 110, 0), nameof(vmLap2018.BrushMaterialUnten));
        ...
        libWpf.EllipseMarginStrokeBindingFilling(19, 2, 18, 2, new Thickness(0, 0, 0, 0), Brushes.Gray, 2, nameof(vmLap2018.BrushQ1));
        ...
        libWpf.PolygonBindingMargin(1, 20, 21, 10, Brushes.White, Brushes.Black, 2, new[] {
        ...
        libWpf.RectangleFillBindingMargin(1, 20, 21, 10, Brushes.Firebrick, nameof(vmLap2018.MarginPostionWagenInhalt));

        libWpf.Text("B1", 17, 2, 28, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ImageMarginZweiBilderBindingVisibility("InitiatorenSchliesser.jpg", "InitiatorenBetaetigt.jpg", 19, 2, 28, 2, new Thickness(0, 0, 0, 0), nameof(vmLap2018.VisibilityEinB1), nameof(vmLap2018.VisibilityEinB1));

        libWpf.Text("B2", 10, 2, 28, 2, HorizontalAlignment.Center, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.ImageMarginZweiBilderBindingVisibility("InitiatorenSchliesser.jpg", "InitiatorenBetaetigt.jpg", 12, 2, 28, 2, new Thickness(0, 0, 0, 0), nameof(vmLap2018.VisibilityEinB2), nameof(vmLap2018.VisibilityEinB2));
        ...
        libWpf.EllipseMarginStrokeBindingFilling(27, 3, 2, 3, kreisRand, Brushes.Black, 2, nameof(vmLap2018.BrushP1));
        libWpf.EllipseMarginStrokeBindingFilling(32, 3, 2, 3, kreisRand, Brushes.Black, 2, nameof(vmLap2018.BrushP2));
