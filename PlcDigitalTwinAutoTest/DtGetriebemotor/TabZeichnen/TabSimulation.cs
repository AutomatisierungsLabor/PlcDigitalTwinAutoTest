...
public partial class TabZeichnen
{
    public static void TabSimulationZeichnen(VmGetriebemotor vmGetriebemotor, TabItem tabItem, string hintergrund)
    {
        ...
        libWpf.RipKreisFillStrokeMargin(7, 8, 2, 8, Brushes.SlateGray, Brushes.SlateGray, 0, new Thickness(2, 2, 2, 2));
        ...
        libWpf.RipButtonContentRounded(3, 3, 11, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmGetriebemotor.BtnTaster, WpfObjects.S1);

        libWpf.Text("-S2", 1, 2, 16, 3, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.RipButtonContentRounded(3, 3, 16, 3, 50, 15, buttonRand, Brushes.Red, vmGetriebemotor.BtnTaster, WpfObjects.S2);
        ...
        libWpf.RipButtonContentRounded(10, 3, 11, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmGetriebemotor.BtnTaster, WpfObjects.S3);

        libWpf.Text("-S4", 8, 2, 14, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.RipButtonContentRounded(10, 3, 14, 2, 30, 5, buttonRand, Brushes.Red, vmGetriebemotor.BtnTaster, WpfObjects.S4);

        libWpf.Text("-S5", 8, 2, 16, 3, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.RipButtonContentRounded(10, 3, 16, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmGetriebemotor.BtnTaster, WpfObjects.S5);
        ...
        libWpf.RipButtonContentRounded(17, 3, 11, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmGetriebemotor.BtnTaster, WpfObjects.S6);

        libWpf.Text("-S7", 15, 2, 14, 2, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.RipButtonContentRounded(17, 3, 14, 2, 30, 5, buttonRand, Brushes.Red, vmGetriebemotor.BtnTaster, WpfObjects.S7);

        libWpf.Text("-S8", 15, 2, 16, 3, HorizontalAlignment.Left, VerticalAlignment.Center, 20, Brushes.Black);
        libWpf.RipButtonContentRounded(17, 3, 16, 3, 50, 15, buttonRand, Brushes.LawnGreen, vmGetriebemotor.BtnTaster, WpfObjects.S8);
        ...
        libWpf.RipKreisStrokeMarginSetFilling(3, 3, 20, 3, kreisRandFarbe, kreisRand, WpfObjects.P1);
        ...
        libWpf.RipKreisStrokeMarginSetFilling(10, 3, 20, 3, kreisRandFarbe, kreisRand, WpfObjects.P2);
        ...
        libWpf.RipKreisStrokeMarginSetFilling(17, 3, 20, 3, kreisRandFarbe, kreisRand, WpfObjects.P3);


        libWpf.RipButtonZweiBilder(20, 4, 4, 4, "NotHalt.jpg", "NotHaltGedrueckt.jpg", buttonRand, vmGetriebemotor.BtnSchalter, WpfObjects.S91);
